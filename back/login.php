            ...
            <div class="col-lg-6">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><small>¿Olvidaste tu contraseña?</small><a href="recuperar.php" class="forgot-pass">Recuperala  </a><br><small>¿No tienes cuenta?  </small><a href="registro.php" class="signup">Registrate</a>
                </div>
              </div>
            </div>
          </div>
