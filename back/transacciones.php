      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Transacciones</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        $trans = $db->select("transacciones",["[><]tipo" => ["tra_tip" => "tip_id"],
                                                         ...
                                                         ["transacciones.tra_id",
                                                         "tipo.tip_nom",
                                                         "categorias.cat_nom",
                                                         "transacciones.tra_nom",
                                                         "transacciones.tra_cant",
                                                         "transacciones.tra_fa"]);
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="#" class="editar_equipo" data-id="<?php echo $tra["tra_id"];?>>">
                              <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            </a>
                          </td>
                          <td>
                            <a href="#" class="eliminar_equipo" data-id="<?php echo $tra["tra_id"];?>">
  ...
  <div id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header"><strong id="exampleModalLabel" class="modal-title">Agregar Transaccion</strong>
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="guardarTra" class="btn btn-primary">Guardar</button>
        </div>
      </div>
    </div>
  </div>
